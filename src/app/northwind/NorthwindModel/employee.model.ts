...
export class EmployeeModel<E extends Employee> extends ODataModel<E> {
  ...
  public $Employees1() {
    return this.getAttribute<Employee>('Employees1') as Employee;
  }
  ...
  public Employees1$(options?: ODataQueryArgumentsOptions<Employee>) {
    return this.fetchAttribute<Employee>('Employees1', options) as Observable<Employee>;
  }
  ...
  public $Employee1() {
    return this.getAttribute<Employee>('Employee1') as Employee;
  }
  ...
  public Employee1$(options?: ODataQueryArgumentsOptions<Employee>) {
    return this.fetchAttribute<Employee>('Employee1', options) as Observable<Employee>;
  }
