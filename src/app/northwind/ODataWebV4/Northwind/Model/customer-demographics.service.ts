...
export class CustomerDemographicsService extends ODataEntitySetService<CustomerDemographic> {
  ...
  customerDemographicModel(entity?: Partial<CustomerDemographic>): CustomerDemographicModel<CustomerDemographic> {
    return this.entity().asModel<CustomerDemographicModel<CustomerDemographic>>(entity);
  }//#endregion
  //#region ODataApiGen Collection
  customerDemographicCollection(entities?: Partial<CustomerDemographic>[]): CustomerDemographicCollection<CustomerDemographic, CustomerDemographicModel<CustomerDemographic>> {
    return this.entities().asCollection<CustomerDemographicModel<CustomerDemographic>, CustomerDemographicCollection<CustomerDemographic, CustomerDemographicModel<CustomerDemographic>>>(entities);
  }//#endregion
