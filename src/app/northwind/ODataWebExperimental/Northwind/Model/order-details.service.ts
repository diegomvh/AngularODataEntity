...
export class OrderDetailsService extends ODataEntitySetService<OrderDetail> {
  ...
  orderDetailModel(entity?: Partial<OrderDetail>): OrderDetailModel<OrderDetail> {
    return this.entity().asModel<OrderDetailModel<OrderDetail>>(entity);
  }//#endregion
  //#region ODataApiGen Collection
  orderDetailCollection(entities?: Partial<OrderDetail>[]): OrderDetailCollection<OrderDetail, OrderDetailModel<OrderDetail>> {
    return this.entities().asCollection<OrderDetailModel<OrderDetail>, OrderDetailCollection<OrderDetail, OrderDetailModel<OrderDetail>>>(entities);
  }//#endregion
