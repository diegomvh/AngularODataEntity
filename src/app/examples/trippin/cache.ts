import { ODataClient, ODataEntityAnnotations, ODataInStorageCache, ODataServiceFactory } from "angular-odata";
...
export default async (injector: Injector) => {
    ...
    const tripPinCache = tripPinApi.cache as ODataInStorageCache;
    tripPinCache.flush();
