...
export class ArticleModel<E extends Article> extends ODataModel<E> {
  ...
  public getArticleType(options?: ODataOptions) {
  ...
  public getArticleTypeInt(options?: ODataOptions) {
  ...
  public getErrata(options?: ODataOptions) {
  ...
  public getISSN(options?: ODataOptions) {
  ...
  public getISBN(options?: ODataOptions) {
