...
export class GroupsService extends ODataEntityService<Group> {
  ...
  groupModel(): GroupModel<Group> {
    return this.entity().asModel() as GroupModel<Group>;
  }
  //#endregion
  //#region ODataApi Collection
  groupCollection(): GroupCollection<Group, GroupModel<Group>> {
    return this.entities().asCollection() as GroupCollection<Group, GroupModel<Group>>;
  }
  //#endregion
  ...
  public checkGrantedPermissionsForApp(entity: EntityKey<Group>): ODataActionResource<null, ResourceSpecificPermissionGrant> {
    const resource = this.entity(entity).action<null, ResourceSpecificPermissionGrant>('microsoft.graph.checkGrantedPermissionsForApp');
    return resource;
  }
