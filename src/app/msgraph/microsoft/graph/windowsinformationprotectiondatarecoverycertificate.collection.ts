...
export class WindowsInformationProtectionDataRecoveryCertificateCollection<E extends WindowsInformationProtectionDataRecoveryCertificate, M extends WindowsInformationProtectionDataRecoveryCertificateModel<E>> extends ODataCollection<E, M> {
