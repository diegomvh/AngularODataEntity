...
export class ManagedDeviceMobileAppConfigurationDeviceStatusCollection<E extends ManagedDeviceMobileAppConfigurationDeviceStatus, M extends ManagedDeviceMobileAppConfigurationDeviceStatusModel<E>> extends EntityCollection<E, M> {
