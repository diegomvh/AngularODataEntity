...
import { PermissionGrantsServiceConfig } from './permissiongrants.service.config';
import { ScopedRoleMembershipsServiceConfig } from './scopedrolememberships.service.config';
...
import { ChatsServiceConfig } from './chats.service.config';
...
export const GraphServiceContainer = {
  ...
  services: [
    ...
    PermissionGrantsServiceConfig,
    ScopedRoleMembershipsServiceConfig,
