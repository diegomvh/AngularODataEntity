...
export class UserModel<E extends User> extends DirectoryObjectModel<E> {
  ...
  scopedRoleMemberOf?: ScopedRoleMembershipCollection<ScopedRoleMembership, ScopedRoleMembershipModel<ScopedRoleMembership>>;
  ...
  teamwork?: UserTeamworkModel<UserTeamwork>;
  todo?: TodoModel<Todo>;
  //#endregion
