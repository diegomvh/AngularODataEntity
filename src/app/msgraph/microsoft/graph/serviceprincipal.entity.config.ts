...
export const ServicePrincipalConfig = {
  ...
  collection: ServicePrincipalCollection,
  annotations: [],
  fields: {
    ...
    appDescription: {type: 'Edm.String'},
    ...
    delegatedPermissionClassifications: {type: 'graph.delegatedPermissionClassification', collection: true, navigation: true},
