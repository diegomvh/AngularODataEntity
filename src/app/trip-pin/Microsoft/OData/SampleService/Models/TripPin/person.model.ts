...
export class PersonModel<E extends Person> extends ODataModel<E> {
  ...
  public $Friends() {
    return this.getAttribute<Person>('Friends') as Person;
  }
  ...
  public Friends$(options?: ODataQueryArgumentsOptions<Person>) {
    return this.fetchAttribute<Person>('Friends', options) as Observable<Person>;
  }
  ...
  public $Trips() {
    return this.getAttribute<Trip>('Trips') as Trip;
  }
  ...
  public Trips$(options?: ODataQueryArgumentsOptions<Trip>) {
    return this.fetchAttribute<Trip>('Trips', options) as Observable<Trip>;
  }
  ...
  public $Photo() {
    return this.getAttribute<Photo>('Photo') as Photo;
  }
  ...
  public Photo$(options?: ODataQueryArgumentsOptions<Photo>) {
    return this.fetchAttribute<Photo>('Photo', options) as Observable<Photo>;
  }
