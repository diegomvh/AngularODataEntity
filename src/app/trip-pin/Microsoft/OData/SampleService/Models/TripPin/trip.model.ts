...
export class TripModel<E extends Trip> extends ODataModel<E> {
  ...
  public $Photos() {
    return this.getAttribute<Photo>('Photos') as Photo;
  }
  ...
  public Photos$(options?: ODataQueryArgumentsOptions<Photo>) {
    return this.fetchAttribute<Photo>('Photos', options) as Observable<Photo>;
  }
  ...
  public $PlanItems() {
    return this.getAttribute<PlanItem>('PlanItems') as PlanItem;
  }
  ...
  public PlanItems$(options?: ODataQueryArgumentsOptions<PlanItem>) {
    return this.fetchAttribute<PlanItem>('PlanItems', options) as Observable<PlanItem>;
  }
